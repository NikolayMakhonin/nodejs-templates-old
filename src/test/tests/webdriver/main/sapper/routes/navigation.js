	...
	'base'() {
		...
		return this.remote
			...
			.testPage(() => this.remote
				...
				.click()
				.getCurrentUrl()
				.then(o => assert.strictEqual(new URL(o).pathname, '/sapper/page/about'))
				.end()

				.findByCssSelector('[href=blog]')
				.click()
				.getCurrentUrl()
				...
				.click()
				.getCurrentUrl()
				.then(o => assert.strictEqual(new URL(o).pathname, '/sapper/page/blog/what-is-sapper'))
				.end()

				.findByCssSelector('[href="."]')
				.click()
				.getCurrentUrl()
				.then(o => assert.strictEqual(new URL(o).pathname, '/sapper/page/'))
				.end()
			)
	}
})
