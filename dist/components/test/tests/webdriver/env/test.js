...
var keys_1 = createCommonjsModule(function (module, exports) {
  ...
  /**
   * A list of special keys that can be used with the `pressKeys` and `type`
   * functions.
   *
  ...
  var keys = {
    ...
    /**
     * The help key. This key only appears on older Apple keyboards in place of
     * the Insert key.
     */
    HELP: '\uE002',
    ...
    /**
     * The clear key. This key only appears on full-size Apple keyboards in
