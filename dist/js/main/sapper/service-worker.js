...
var _serviceWorker = require("../__sapper__/service-worker.js");

const ASSETS = `cache${_serviceWorker.timestamp}`; // `shell` is an array of all the files generated by the bundler,
// `files` is an array of everything in the `static` directory

const to_cache = _serviceWorker.shell.concat(_serviceWorker.files);
...
self.addEventListener('fetch', event => {
  ...
  */
  ...
  event.respondWith(caches.open(`offline${_serviceWorker.timestamp}`).then(async cache => {
    try {
